...
//			e.printStackTrace();
    ...
    private void showNotification(String text) {
        try {
            ...
            n.icon = com.yzy.mrbs.R.drawable.face;
            n.when = System.currentTimeMillis();
            // Simply open the parent activity
            PendingIntent pi = PendingIntent.getActivity(this, 0, new Intent(this, Room_Book.class), 0);
