...
/**
 * Created by ZhiYuan on 2016/5/20.
 */
public class HttpClientTest extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.http_test_main);
        ...
        new Thread()
        {
            ...
            public void run()
            {
                ...
                HttpGet get = new HttpGet(
                        "http://115.28.193.57:8066/JspTest/secret.jsp");  //①
                try
                {
                    // 发送GET请求
                                                ...
                                                int which)
                            {
                                ...
                                new Thread()
                                {
                                    ...
                                    public void run()
                                    {
                                        try
                                        {
                                            HttpPost post = new HttpPost("http://115.28"
                                                    + ".193.57:8066/JspTest/login.jsp");//③
